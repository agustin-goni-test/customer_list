...
from contact_data import EmailJuridica, PhoneNumberJuridica, PhoneNumberNatural, ContactDataSummaryJuridica
...
def main():
    ...
    # print(json.dumps(response_natural, indent=4))
    ...
    # print("Escribiendo bloque entre filas 0 y 4 en archivo Excel... \n")
    ...
    # print("Escribiendo bloque entre filas 5 y 10 en archivo Excel... \n")
    ...
    for start in range(start_position, total_rows, block_size):
        ...
        # if end < total_rows - 1:
        #     while True:
        #         user_input = input("Continuar con el siguiente bloque? (s/n): ").strip().lower()
        #         if user_input == 's':
        #             break
        #         elif user_input == 'n':
